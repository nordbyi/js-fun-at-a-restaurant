...
// Express the following in code: If the variable "stockCount" (inStock?) is greater or equal to 1, log
// the statement 'I'm going to eat some [food]!', otherwise, log the statement
// 'We need to get some more [food].'
console.log(inStock >= 1 ? `I'm going to eat some ${food}` : `We need to get some more ${food}`)
...
var vegetables = ['carrots', 'broccoli', 'onions', 'celery', 'spinach']
...
// different fruits.
var fruits = ['apples', 'oranges', 'tomatoes', 'watermelons', 'strawberries', 'bananas', 'grapes']
...
// keys: name, and isOpen. The value for name should the string 'King Soopers' (or your favorite grocery store), and the value for isOpen should be true. Which other key value pairs would make sense to add to this object?
var groceryStore = {
  name: 'King Soopers',
  isOpen: true,
  distanceInMiles: 4.3,
